...
std::array<std::array<Cells, map_width>, map_height> convert_map(std::array<std::string, map_height> map, Pacman& pacman, const std::array<Position, 4>& ghost_positions) {
